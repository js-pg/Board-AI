...
function promptWinner(player) {
    ...
    `, true)
        ...
        setModalContent(`
        <div class="w-100 mt-3 d-flex flex-column justify-content-center align-items-center"><h1 class="alert--win w-100 text-center">Game Result:<br><span>${player} wins!</h1></span><br><h2 class="m-2 text-center d-flex justify-content-center align-items-center">Point 1 ${svgArrowRight} 3</h2><button onclick="resetAndHide()" class="btn btn-move-preview">New Game</button></div>
